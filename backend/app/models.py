...
class Butaca(Base):
    ...
    tipo_butaca: Mapped[str] = mapped_column(String) # "platea" o "balcon"
    ...
    comprador_username: Mapped[Optional[str]] = mapped_column(String, ForeignKey("users.username"), nullable=True)
